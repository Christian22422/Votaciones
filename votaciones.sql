...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2024 a las 19:54:47
...
CREATE TABLE `candidato` (
  ...
  `nombre_cand` varchar(45) NOT NULL
...
INSERT INTO `candidato` (`id_candidato`, `nombre_cand`) VALUES
(1, 'Bert Patterson'),
(2, 'Todd Rollins'),
(3, 'Tara Gilmore'),
(4, 'Shelby Mclaughlin'),
...
CREATE TABLE `votante` (
  ...
  `entero_por` varchar(25) NOT NULL,
  `id_region` int(10) UNSIGNED NOT NULL,
  `id_comuna` int(10) UNSIGNED NOT NULL,
...
ALTER TABLE `votante`
  ADD PRIMARY KEY (`rut`),
  ADD KEY `FK_votante_region` (`id_region`),
  ADD KEY `FK_votante_comuna` (`id_comuna`);
...
--
ALTER TABLE `candidato`
  MODIFY `id_candidato` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `votante`
  ADD CONSTRAINT `FK_votante_comuna` FOREIGN KEY (`id_comuna`) REFERENCES `comuna` (`id_comuna`),
  ADD CONSTRAINT `FK_votante_region` FOREIGN KEY (`id_region`) REFERENCES `region` (`id_region`);
COMMIT;
